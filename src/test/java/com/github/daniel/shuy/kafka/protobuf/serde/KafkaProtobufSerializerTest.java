...
public class KafkaProtobufSerializerTest {
  ...
  private <T extends MessageLite> void serialize(T input, Parser<T> parser)
    ...
    Map<String, Object> consumerProps =
        KafkaTestUtils.consumerProps(uuid, Boolean.TRUE.toString(), embeddedKafka);
    ...
    try (Producer<T, T> producer = new KafkaProducer<>(producerProps, serializer, serializer)) {
